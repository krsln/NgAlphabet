...
export class AlphabetService {
  ...
  Aurebesh = () => Database.Aurebesh();
  Futhark = () => Database.Futhark();
  Orkhon = () => Database.Orkhon();
  Yenisei = () => Database.Yenisei();
}

class Database {

  static Aurebesh(sort: boolean = false): Letter[] {
    const sp = LetterType.Separator;
    const l = LetterType.Letter;
    ...
    let alphabet: Letter[] = [
      // {Origin: '.', Type: sp, Vectors: [svgSep]},
      {Origin: ' ', Type: sp, Vectors: [svgSep]},
      {Origin: '!', Type: sp, Vectors: [svgExclamation]},
      {Origin: '.', Type: sp, Vectors: [svgDot]},
      {Origin: ';', Type: sp, Vectors: [svgSemicolon]},

      {Origin: 'a', Type: l, Vectors: [svgA1, svgA2]},
      {Origin: 'e', Type: l, Vectors: [svgE1, svgE2]},
      {Origin: 'i', Type: l, Vectors: [svgI1, svgI2]},
      {Origin: 'o', Type: l, Vectors: [svgO1, svgO2]},
      {Origin: 'u', Type: l, Vectors: [svgU]},
      // {Origin: 'ı', Type: l, Vectors: [svgI]},
      // {Origin: 'ö', Type: l, Vectors: [svgOE]},
      // {Origin: 'ü', Type: l, Vectors: [svgOE]},

      // Consonant
      {Origin: 'b', Type: l, Vectors: [svgB1, svgB2]},
      {Origin: 'c', Type: l, Vectors: [svgC1, svgC2]},
      {Origin: 'ç', Type: l, Vectors: [svgCH]},
      {Origin: 'd', Type: l, Vectors: [svgD1, svgD2]},
      {Origin: 'f', Type: l, Vectors: [svgF1, svgF2]},
      {Origin: 'g', Type: l, Vectors: [svgG1, svgG2]},
      {Origin: 'h', Type: l, Vectors: [svgH1, svgH2]},
      {Origin: 'j', Type: l, Vectors: [svgJ]},
      {Origin: 'k', Type: l, Vectors: [svgK1, svgK2]},
      {Origin: 'l', Type: l, Vectors: [svgL]},
      {Origin: 'm', Type: l, Vectors: [svgM1, svgM2]},
      {Origin: 'n', Type: l, Vectors: [svgN1, svgN2]},
      {Origin: 'p', Type: l, Vectors: [svgP1, svgP2]},
      {Origin: 'q', Type: l, Vectors: [svgQ1, svgQ2]},
      {Origin: 'r', Type: l, Vectors: [svgR]},
      {Origin: 's', Type: l, Vectors: [svgS]},
      {Origin: 't', Type: l, Vectors: [svgT]},
      {Origin: 'v', Type: l, Vectors: [svgV]},
      {Origin: 'w', Type: l, Vectors: [svgW]},
      {Origin: 'x', Type: l, Vectors: [svgX]},
      {Origin: 'y', Type: l, Vectors: [svgY]},
      {Origin: 'z', Type: l, Vectors: [svgZ]},

      // Syllable
      {Origin: 'ae', Type: s, Vectors: [svgAE]},
      {Origin: 'eo', Type: s, Vectors: [svgEO]},
      {Origin: 'kh', Type: s, Vectors: [svgKH]},
      {Origin: 'ng', Type: s, Vectors: [svgNG]},
      {Origin: 'oo', Type: s, Vectors: [svgOO]},
      {Origin: 'sh', Type: s, Vectors: [svgSH]},
      {Origin: 'th', Type: s, Vectors: [svgTH]},
    ];
  ...
  static Futhark(sort: boolean = false): Letter[] {
    const sp = LetterType.Separator;
    const l = LetterType.Letter;
    const s = LetterType.Syllable;
    const bevelStyle = 'fill:none;stroke:#000000;stroke-width:4;stroke-linejoin:bevel;';
    const miterStyle = 'fill:none;stroke:#000000;stroke-width:4;stroke-linejoin:miter;';
    ...
    let alphabet: Letter[] = [
      {Origin: 'a', Type: l, Vectors: [svgA]},
      {Origin: 'e', Type: l, Vectors: [svgE]},
      {Origin: 'i', Type: l, Vectors: [svgI]},
      {Origin: 'o', Type: l, Vectors: [svgO]},
      {Origin: 'u', Type: l, Vectors: [svgU]},

      {Origin: 'b', Type: l, Vectors: [svgB]},
      {Origin: 'd', Type: l, Vectors: [svgD]},
      {Origin: 'f', Type: l, Vectors: [svgF]},
      {Origin: 'g', Type: l, Vectors: [svgG]},
      {Origin: 'h', Type: l, Vectors: [svgH, svgH2]},
      {Origin: 'j', Type: l, Vectors: [svgY]},
      {Origin: 'k', Type: l, Vectors: [svgK]},
      {Origin: 'l', Type: l, Vectors: [svgL]},
      {Origin: 'm', Type: l, Vectors: [svgM]},
      {Origin: 'n', Type: l, Vectors: [svgN]},
      {Origin: 'p', Type: l, Vectors: [svgP]},
      {Origin: 'r', Type: l, Vectors: [svgR]},
      {Origin: 's', Type: l, Vectors: [svgS2, svgS]},
      {Origin: 't', Type: l, Vectors: [svgT]},
      {Origin: 'v', Type: l, Vectors: [svgW]},
      {Origin: 'w', Type: l, Vectors: [svgW]},
      {Origin: 'y', Type: l, Vectors: [svgY]},
      {Origin: 'z', Type: l, Vectors: [svgZ]},

      {Origin: 'th', Type: s, Vectors: [svgTH]},
      {Origin: 'el', Type: s, Vectors: [svgEI]},
      {Origin: 'ng', Type: s, Vectors: [svgNG, svgNG2]},
  ...
  static Orkhon(sort: boolean = false): Letter[] {
    const sp = LetterType.Separator;
    const l = LetterType.Letter;
    const s = LetterType.Syllable;
    const styleText = '';
    ...
    let alphabet: Letter[] = [
      ...
      {Origin: 'a', Type: l, Vectors: [svgAE]},
      {Origin: 'e', Type: l, Vectors: [svgAE]},
      {Origin: 'ı', Type: l, Vectors: [svgIi]},
      {Origin: 'i', Type: l, Vectors: [svgIi]},
      {Origin: 'o', Type: l, Vectors: [svgOU]},
      {Origin: 'u', Type: l, Vectors: [svgOU]},
      {Origin: 'ö', Type: l, Vectors: [svgUU]},
      {Origin: 'ü', Type: l, Vectors: [svgUU]},
      // Consonant
      {Origin: 'b', Type: l, Vectors: [svgB_Kalin, svgB_Ince]},
      {Origin: 'ç', Type: l, Vectors: [svgCH]},
      {Origin: 'd', Type: l, Vectors: [svgD_Kalin, svgD_Ince]},
      {Origin: 'g', Type: l, Vectors: [svgG_Kalin, svgG_Ince]},
      {Origin: 'k', Type: l, Vectors: [svgK_Kalin, svgK_Ince]},
      {Origin: 'l', Type: l, Vectors: [svgL_Kalin, svgL_Ince]},
      {Origin: 'm', Type: l, Vectors: [svgM]},
      {Origin: 'n', Type: l, Vectors: [svgN_Kalin, svgN_Ince]},
      {Origin: 'p', Type: l, Vectors: [svgP]},
      {Origin: 'r', Type: l, Vectors: [svgR_Kalin, svgR_Ince]},
      {Origin: 's', Type: l, Vectors: [svgS_Kalin, svgS_Ince]},
      {Origin: 'ş', Type: l, Vectors: [svgSH]},
      {Origin: 't', Type: l, Vectors: [svgT_Kalin, svgT_Ince]},
      {Origin: 'y', Type: l, Vectors: [svgY_Kalin, svgY_Ince]},
      {Origin: 'z', Type: l, Vectors: [svgZ, svgZ2]},

      // TODO:not have letters
      // C F H Ğ J V eskiden yoktu sonradan diğer dillerden girdi
      {Origin: 'c', Type: l, Vectors: [svgICH]}, // TODO: ?
      {Origin: 'f', Type: l, Vectors: [svgD_Ince]}, // TODO: ?
      {Origin: 'ğ', Type: l, Vectors: [svgG_Kalin]}, // TODO: ?
      {Origin: 'h', Type: l, Vectors: []}, // TODO: ?
      {Origin: 'j', Type: l, Vectors: []}, // TODO: ?
      {Origin: 'q', Type: l, Vectors: [svgK_Kalin]}, // TODO: ?
      {Origin: 'x', Type: l, Vectors: []}, // TODO: ?
      {Origin: 'v', Type: l, Vectors: []}, // TODO: ?
      {Origin: 'w', Type: l, Vectors: []}, // TODO: ?

      // Syllable
      {Origin: 'ık', Type: s, Vectors: [svgIQ]},
      {Origin: 'ki', Type: s, Vectors: [svgIQ]},
      {Origin: 'iç', Type: s, Vectors: [svgICH]},
      {Origin: 'çi', Type: s, Vectors: [svgICH]},
      {Origin: 'ok', Type: s, Vectors: [svgOQ]},
      {Origin: 'uk', Type: s, Vectors: [svgOQ]},
      {Origin: 'ök', Type: s, Vectors: [svgUQ]},
      {Origin: 'ük', Type: s, Vectors: [svgUQ]},
      {Origin: 'ld', Type: s, Vectors: [svgLT]},
      {Origin: 'lt', Type: s, Vectors: [svgLT]},
      {Origin: 'nç', Type: s, Vectors: [svgNCH]},
      {Origin: 'nt', Type: s, Vectors: [svgNT]},
      {Origin: 'nd', Type: s, Vectors: [svgNT]},
      {Origin: 'ng', Type: s, Vectors: [svgNG]},
      {Origin: 'ny', Type: s, Vectors: [svgNY]}
    ];
  ...
  static Yenisei(sort: boolean = false): Letter[] {
    const sp = LetterType.Separator;
    const l = LetterType.Letter;
    const s = LetterType.Syllable;
    const styleText = '';
    ...
    let alphabet: Letter[] = [
      ...
      {Origin: 'i', Type: l, Vectors: [svgI]},
      {Origin: 'o', Type: l, Vectors: [svgO]},
      {Origin: 'u', Type: l, Vectors: [svgO]},
      {Origin: 'ö', Type: l, Vectors: [svgOE]},
      {Origin: 'ü', Type: l, Vectors: [svgOE]},

      // Consonant
      {Origin: 'b', Type: l, Vectors: [svgB1, svgB2, svgB3, svgB4, svgB5, svgB6, svgB7]},
      {Origin: 'c', Type: l, Vectors: [svgC1, svgC2, svgC3]},
      {Origin: 'd', Type: l, Vectors: [svgD1, svgD2, svgD3, svgD4, svgD5]},
      {Origin: 'g', Type: l, Vectors: [svgG1, svgG2, svgG3, svgG4]},
      {Origin: 'k', Type: l, Vectors: [svgK1, svgK2, svgK3, svgK4, svgK5]},
      {Origin: 'l', Type: l, Vectors: [svgL1, svgL2, svgL3]},
      {Origin: 'm', Type: l, Vectors: [svgM1, svgM2]},
      {Origin: 'n', Type: l, Vectors: [svgN1, svgN2, svgN3, svgN4]},
      {Origin: 'p', Type: l, Vectors: [svgP]},
      {Origin: 'r', Type: l, Vectors: [svgR1, svgR2]},
      {Origin: 's', Type: l, Vectors: [svgS1, svgS2, svgS3]},
      // {Origin: 'ş', Type: l, Vectors: [svgSH]},
      {Origin: 't', Type: l, Vectors: [svgT1, svgT2]},
      {Origin: 'y', Type: l, Vectors: [svgY1, svgY2, svgY3]},
      {Origin: 'z', Type: l, Vectors: [svgZ1, svgZ2, svgZ3]},

      // Syllable
      {Origin: 'bd', Type: s, Vectors: [svgBS]},
      {Origin: 'nd', Type: s, Vectors: [svgND]},
      {Origin: 'ng', Type: s, Vectors: [svgNG1, svgNG2, svgNG3, svgNG4]},
      {Origin: 'nj', Type: s, Vectors: [svgNJ1, svgNJ2, svgNJ3, svgNJ4]},
      {Origin: 'n?', Type: s, Vectors: [svgNN1, svgNN2, svgNN3, svgNN4, svgNN5, svgNN6]},
    ];
